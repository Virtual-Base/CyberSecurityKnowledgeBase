# Learn to Hack!
  - [Ethical Hacking in 12 Hours - Full Course](https://www.youtube.com/watch?v=fNzpcB7ODxQ)
  - [Nmap Comprehensive Guide](https://www.yumpu.com/en/document/read/59433067/nmapprojectnmapnetworkscanningtheofficialnmapprojectguidetonetworkdiscoveryandsecurityscanningjan2009isbn0979958717)
  - [Back to BASIC: Everything you SHOULD know about your Computer but don't!](https://www.youtube.com/watch?v=9MKWegSQakM)
  - [sha256algorithm](https://sha256algorithm.com/)
# Ports and Security Series 
...
# NetCat Series
  ...
  - [Netcat III: Relays and Port Forwarding](https://www.youtube.com/watch?v=FLoe9S4TASk&t=916s)
# Email Security 
  - [End to End Email Security with DMARC Records](https://briskinfosec.com/blogs/blogsdetail/End-to-End-Email-Security-with-DMARC-Records)
  - [Internet-Wide Study: State of SPF, DKIM, and DMARC](https://redhuntlabs.com/blog/internet-wide-study-state-of-spf-dkim-and-dmarc.html)
# Linux
  - [File Permissions in Linux / Unix: How to Read, Write & Change?](https://www.guru99.com/file-permissions.html)
  - [Use SSH Config File to Manage SSH Connections to Various Remote Servers](https://linuxhandbook.com/ssh-config-file/) 
  - [A to Z Linux Commands](https://linuxhandbook.com/a-to-z-linux-commands/)
# Interview Questions
  - [Cybersecurity Interview Question Bank](https://hela-lucas.com/2020/03/12/cybersecurity-interview-question-bank/)
  - [App Sec / Pentest Experienced Interview Questions (2–6 yrs)](https://medium.com/@MrCatalyst/app-sec-pentest-experienced-interview-questions-2-6-yrs-486e99dc1a9a)
# Hardening 
  - [awesome-security-hardening](https://github.com/decalage2/awesome-security-hardening#tlsssl)
